    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(default=None, max_length=1000, null=True)),
                ...
                ('spouses', models.CharField(default=None, max_length=300, null=True)),
                ('award', models.CharField(default=None, max_length=300, null=True)),
                ('bio', models.CharField(default=None, max_length=1000, null=True)),
                ('children', models.CharField(default=None, max_length=300, null=True)),
                ('relatives', models.CharField(default=None, max_length=300, null=True)),
                ...
                ('parents', models.CharField(default=None, max_length=300, null=True)),
                ('officialsite', models.CharField(default=None, max_length=300, null=True)),
                ('born', models.DateField(default=None, null=True)),
                ('starmeter', models.IntegerField(default=None, null=True)),
                ('Height', models.DecimalField(blank=True, decimal_places=2, default=None, max_digits=6, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Help',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sold', models.CharField(default=None, max_length=300, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('video', models.CharField(default=None, max_length=1000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('platform', models.CharField(default=None, max_length=1000, null=True)),
                ('game', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='platform', to='games.videogame')),
            ],
        ),
        migrations.CreateModel(
            name='Photo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('castvideo', models.CharField(default=None, max_length=1000, null=True)),
                ('game', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='castvideos', to='games.cast')),
            ],
        ),
        migrations.CreateModel(
            name='CastTrivia',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('casttrivia', models.CharField(default=None, max_length=1000, null=True)),
                ('game', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='casttrivias', to='games.cast')),
            ],
        ),
        migrations.CreateModel(
            name='CastTrademark',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('casttrademark', models.CharField(default=None, max_length=1000, null=True)),
                ('game', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='casttrademarks', to='games.cast')),
            ],
        ),
        migrations.CreateModel(
            name='CastSalary',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('castsalary', models.CharField(default=None, max_length=1000, null=True)),
                ('game', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='castsalaries', to='games.cast')),
            ],
        ),
        migrations.CreateModel(
            name='CastQuote',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('castquote', models.CharField(default=None, max_length=1000, null=True)),
                ('game', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='castquotes', to='games.cast')),
            ],
        ),
        migrations.CreateModel(
            name='CastPhoto',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('castphoto', models.FileField(default=None, null=True, upload_to='cast/photos/')),
                ('game', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='castphotos', to='games.cast')),
            ],
        ),
        migrations.CreateModel(
            name='CastGoof',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('castgoof', models.CharField(default=None, max_length=1000, null=True)),
                ('game', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='castgoofs', to='games.cast')),
            ],
        ),
        migrations.CreateModel(
            name='CastFaqs',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('castfaq', models.CharField(default=None, max_length=1000, null=True)),
                ('game', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='castfaqs', to='games.cast')),
            ],
        ),
        migrations.AddField(
            model_name='cast',
            name='game',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='casts', to='games.videogame'),
        ),
        migrations.CreateModel(
            name='WatchList',
            fields=[
